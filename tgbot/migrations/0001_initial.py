# Generated by Django 4.0.7 on 2022-08-22 06:51
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', models.FileField(null=True, upload_to=tgbot.models.user_directory_path, verbose_name='Файл, видео')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('files', models.ManyToManyField(blank=True, to='tgbot.file', verbose_name='Картинки, Видео, Файлы')),
                ('group', models.ForeignKey(blank=True, help_text='Группы пользователей, для которых доступно данное сообщение. Если группа не выбрана, сообщение доступно всем пользователям.', null=True, on_delete=django.db.models.deletion.SET_NULL, to='tgbot.group', verbose_name='Группы пользователей')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('birth_date', models.DateField(blank=True, verbose_name='День Рождения')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='tgbot.group')),
                ('message', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='tgbot.message')),
